...
void List::dataInserting(AVLnode* data1) // Ввод данных в верхний элемент списка
{
	Head->FirstInf = data1;
}
...
unsigned List::IndexforData(AVLnode* data1) // Получение индекса по значению внутри элемента
{
	unsigned Index = 0;
	bool isDataExists = 0;
	box* Item = Head;
